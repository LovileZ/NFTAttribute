...
api_url = "https://mainnet.infura.io/v3/fd63f35277f44785b28203d0aad096ed"  # YOU WILL NEED TO PROVIDE THE URL OF AN ETHEREUM NODE
...
def get_ape_info(ape_id):
    ...
    # Extract image and eyes attributes from metadata
